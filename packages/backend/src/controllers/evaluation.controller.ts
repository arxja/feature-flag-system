...
export const evaluationController = {
  // GET /api/evaluate/:flagKey
  async evaluateSingleFlag(req: Request, res: Response) {
    try {
  ...
  async evaluateBatchFlags(req: Request, res: Response) {
    try {
  ...
  // GET /api/evaluate/:flagKey/explain
  async explainEvaluationLogic(req: Request, res: Response) {
    try {
      const { flagKey } = req.params;
  ...
  // POST /api/evaluate/test-setup
  async setupTestFlags(req: Request, res: Response) {
